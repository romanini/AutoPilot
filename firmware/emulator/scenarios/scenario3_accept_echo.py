...
# Ensure firmware/emulator/ is on sys.path so nmea/geo/garmin_emulator are importable
# whether this script is run from the repo root or from firmware/emulator/.
